...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentStartResponse startPayment(UUID registrationId, PaymentStartRequest request, Authentication authentication) {
        ...
        sandboxRequest.setReturnUrl(paymentReturnUrl(registration.getId()));
    ...
    public PaymentWebhookResponse simulateGatewayServerFailure(PaymentWebhookRequest request, String signature) {
        ...
        failedRequest.setReturnUrl(paymentReturnUrl(transaction.getRegistration().getId()));
    ...
    private String paymentReturnUrl(UUID registrationId) {
        return frontendBaseUrl + "/student/tickets/" + registrationId + "/payment";
    }

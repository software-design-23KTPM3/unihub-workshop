...
public class Notification {
    ...
    public static class NotificationBuilder {
        ...
        public NotificationBuilder studentId(String studentId) {
            this.studentId = studentId;
            return this;
        }
        ...
        public NotificationBuilder workshopId(UUID workshopId) {
            this.workshopId = workshopId;
            return this;
        }

        public Notification build() {
            return new Notification(studentId, type, content, status, workshopId);
        }
    }
}
